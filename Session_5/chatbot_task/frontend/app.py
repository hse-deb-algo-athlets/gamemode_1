            ...
            with gr.Row():
                ...
                with gr.Column(scale=6):
                    chatbot_1 = gr.ChatInterface(
                        ...
                        examples=["Stelle mir eine Frage","Antwort: "],
                        textbox=gr.Textbox(placeholder="Stelle mir Fragen...", container=False, scale=2),
                        clear_btn="Clear",
                    )
                ...
                with gr.Column(scale=1, min_width=100):
                    ...
                    button_refresh.click(fn=user,inputs=name_input,outputs=points_output)
                    #pdfs einlesen
                    ...
                    button_login.click(fn=pdf_dropdown_choices,outputs=pdf_choice)
